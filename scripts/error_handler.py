...
GIT_ERRORS: Dict[str, Dict[str, Any]] = {
    "GIT_PUSH_REJECTED": {
        "patterns": [
...
class ErrorHandler:
    ...
    @staticmethod
    def identify_error(error_output: str) -> Tuple[Optional[str], Optional[Dict[str, Any]]]:
        """
    ...
    @staticmethod
    def get_recovery_steps(error_code: str) -> List[str]:
    ...
    @staticmethod
    def format_error_message(error_code: str, lang: str = "en") -> Optional[str]:
    ...
    @staticmethod
    def format_for_ai(error_code: str, error_output: str) -> Dict[str, Any]:
    ...
    @staticmethod
    def get_bash_recovery_script(error_code: str) -> str:
